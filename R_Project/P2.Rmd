...
```{r}
selectedVarAllDataPatient <- allDataPatientStudyDS %>%
  select("Group","Age", "Medication", "Length_Parkinson","H_Y", "Handedness",)

selectedVarAllDataPatient
```


```{r}
selectedVarPDGroupsStudy <- allDataPDGroupsStudyDS %>%
  select("Group", "Age")
